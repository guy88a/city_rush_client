...
namespace CityRush.World.Buildings.Registry
{
    ...
    {
        public string Key;       // Example: "Separator_Standard_Left_WW"
        public GameObject Prefab;
    }

    [CreateAssetMenu(menuName = "CityRush/Registry/SeparatorRegistry")]
    public class SeparatorRegistry : ScriptableObject
    {
        public List<SeparatorEntry> Entries = new List<SeparatorEntry>();
