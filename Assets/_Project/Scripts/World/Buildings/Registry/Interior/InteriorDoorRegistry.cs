...
{
    [Serializable]
    public struct InteriorDoorEntry
    {
        public string Key;
        public GameObject Prefab;
    }

    [CreateAssetMenu(menuName = "CityRush/Registry/Interior/DoorRegistry")]
    public class InteriorDoorRegistry : ScriptableObject
    {
        public List<InteriorDoorEntry> Entries = new List<InteriorDoorEntry>();
